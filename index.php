                            ...
                            <ol id="sample" class="ticker">
                                ...
                                <?php
                                    ...
                                    foreach ($articles as $article) {
                                        ...
                                        $newsUrl = htmlspecialchars($article['url'] ?? '');
                                        $date = !empty($article['publishedAt']) ? date('F d, Y', strtotime($article['publishedAt'])) : '';

                                        echo '<li>
                                                    <a href="' . $newsUrl . '" target="_blank">' . substr($title, 0, 60) . '...</a> 
                                                </li>';
                                    }
                                } else {
                    ...
                    <div class="col-md-8 col-sm-12 mb-4">
                        ...
                        if ($api_ok) {
                            ...
                            foreach ($articles as $article) {
                                if (empty($article['title']) || empty($article['url']))
                                    continue;
                                $imageUrl = !empty($article['urlToImage']) ? htmlspecialchars($article['urlToImage']) : 'https://via.placeholder.com/300x200?text=No+Image';
                            ...
                            <img src="' . $imageUrl . '" alt="news" class="img-fluid width-100">
                            <div class="mask-content-lg">
                                ...
                                <h1 class="title-medium-light d-none d-sm-block">
                                    <a href="' . $newsUrl . '" target="_blank"> ' . substr($title, 0, 160) . '...</a>
                                </h1>
                            </div>
                        </div>';
                            }
                                ...
                                echo '<div class="img-overlay-70 img-scale-animate mb-4">
                                    <div class="mask-content-sm">
                                        ...
                                        <h3 class="title-medium-light">
                                            <a href="' . $newsUrl . '" target="_blank">' . substr($title, 0, 55) . '...</a>
                                        </h3>
                                    </div>
                                    <img src="' . $imageUrl . '" alt="news" class="img-fluid width-100" style="height: 220px; object-fit: cover;">
                                </div>';
                            }
                        }
                        ?>
                                                                ...
                                                                <li>
                                                                    <span>
                                                                        <i class="fa fa-calendar"
                                                                            aria-hidden="true"></i>
                                                                    </span>January 14, 2017
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <h3 class="title-medium-dark mb-none">
                                                            <a href="single-news-2.html">Gloost better they are with a
                                                                featured</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <span>
                                                                        <i class="fa fa-calendar"
                                                                            aria-hidden="true"></i>
                                                                    </span>February 14, 2017
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <h3 class="title-medium-dark mb-none">
                                                            <a href="single-news-2.html">Banning Winter Holiy Islands
                                                                Offers</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="media bg-body item-shadow-gray mb-30">
                                                    ...
                                                    <div class="media-body media-padding10">
                                                        ...
                                                        <h3 class="title-medium-dark mb-none">
                                                            <a href="single-news-2.html">Tokyo Fashion Week Itself Great
                                                                Again</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <span>
                                                                        <i class="fa fa-calendar"
                                                                            aria-hidden="true"></i>
                                                                    </span>September 29, 2017
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <h3 class="title-medium-dark mb-none">
                                                            <a href="single-news-2.html">Basketball Stars Face Off in
                                                                Ultimate.</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <span>
                                                                        <i class="fa fa-calendar"
                                                                            aria-hidden="true"></i>
                                                                    </span>November 06, 2017
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <h3 class="title-medium-dark mb-none">
                                                            <a href="single-news-2.html">Landscapes of Lynn
                                                                Zimmerman</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                ...
                                <ul class="item-box-light-mix item-shadow-gray">
                                    <li>
                                        ...
                                        <h3 class="title-medium-dark">
                                            <a href="single-news-3.html">Erik Jones has day he won’t soon forget Denny
                                                backup at Bristol</a>
                                        </h3>
                                    </li>
                                </ul>
                            ...
                            echo '
                                <div class="hover-show-play-btn item-shadow-gray mb-30">
                                    <div class="img-overlay-70">
                                        <img src="' . $imageUrl . '" alt="news" class="img-fluid width-100" style="height: 200px; object-fit: cover;">
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 mb-30">
                        ...
                        if (!empty($entertainment_news)) {
                            ...
                            $main_img = !empty($main_article['urlToImage']) ? htmlspecialchars($main_article['urlToImage']) : 'https://via.placeholder.com/380x270?text=No+Image';
                            $main_title = htmlspecialchars($main_article['title'] ?? 'No Title');
                            $main_url = htmlspecialchars($main_article['url'] ?? '#');
                            ...
                            <div class="img-overlay-70 img-scale-animate">
                                <div class="mask-content-sm">
                                    ...
                                    <h3 class="title-medium-light"><a href="' . $main_url . '" target="_blank">' . substr($main_title, 0, 70) . '...</a></h3>
                                </div>
                                <img src="' . $main_img . '" alt="news" class="img-fluid width-100" style="height: 270px; object-fit: cover;">
                            </div>
                            ...
                            foreach ($sub_articles as $article) {
                                ...
                                $sub_url = htmlspecialchars($article['url'] ?? '#');
                                ...
                                <li>
                                    ...
                                    <h3 class="title-medium-dark"><a href="' . $sub_url . '" target="_blank">' . substr($sub_title, 0, 80) . '...</a></h3>
                                </li>';
                            }
                            echo '</ul>';
                        } else {
                            ...
                            <div class="col-sm-6 col-12 mb-4">
                                <div class="img-overlay-70">
                                    <div class="mask-content-sm">
                                        ...
                                        <h3 class="title-medium-light">
                                            <a href="single-news-3.html">Patricia Urquiola transparent area furney
                                                Italia with iridescent</a>
                                        </h3>
                                    </div>
                                    <div class="text-center">
                                            ...
                                            <div class="media item-shadow-gray bg-body media-none--sm">
                                                ...
                                                <div class="media-body media-padding30 p-mb-none-child">
                                                    ...
                                                    <h3 class="title-semibold-dark size-lg mb-15">
                                                        <a href="single-news-1.html">Football meras on the back
                                                            SepatheyTG G6 will have theytics.</a>
                                                    </h3>
                                                    <p>Separated they right at the coast a large ocean. A small river
                                                        named
                                        ...
                                        <div class="col-md-12 col-sm-6 col-12 mb-30">
                                            <div class="media item-shadow-gray bg-body media-none--sm">
                                                ...
                                                <div class="media-body media-padding30 p-mb-none-child">
                                                    ...
                                                    <h3 class="title-semibold-dark size-lg mb-15">
                                                        <a href="single-news-1.html">Erik Jones has day he won’t soon
                                                            forget as Denny backup at Bristol</a>
                                                    </h3>
                                                    <p>Separated they right at the coast a large ocean. A small river
                                                        named
                                                        Duden flows by their place and ...
                                        ...
                                        <div class="col-md-12 col-sm-6 col-12 mb-30">
                                            <div class="media item-shadow-gray bg-body media-none--sm">
                                                ...
                                                <div class="media-body media-padding30 p-mb-none-child">
                                                    ...
                                                    <h3 class="title-semibold-dark size-lg mb-15">
                                                        <a href="single-news-1.html">A taste of what we like this week
                                                            at CookA like this current
                                                            week
                                                        </a>
                                                    </h3>
